...
<CardGroup cols={2}>
  <Card title="Emails" icon="mail" href="https://mintlify.com/docs/resend">
    Setup Resend for One-Time-Login code emails, and subscription success.
  </Card>
  <Card title="Stripe" icon="image" href="https://mintlify.com/docs/stripe">
    Setup Stripe account for subscription payments and one-time payments.
  </Card>
  <Card title="Fly.io" icon="image" href="https://mintlify.com/docs/stripe">
...
<CardGroup cols={2}>
  ...
  <Card title="Prisma Model" icon="stars" href="https://mintlify.com/customers">
